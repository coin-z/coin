...
public:
    ...
    {
        coin::data::__inner::Allocator< coin::data::ProcessMutex > mutex_alloc;
        mutex_ = mutex_alloc.allocate(1);
        mutex_alloc.construct(mutex_);

        coin::data::__inner::Allocator< counter_t > cnt_alloc;
    ...
    inline T* get() const noexcept { return raw_ptr_; }
...
private:
    ...
    void decreace_() noexcept
    {
        if(this->used_counter_)
        {
            ...
            {
                coin::data::__inner::Allocator<T> data_alloc;
                ...
                // 解锁
                this->mutex_->unlock();
                coin::data::__inner::Allocator< ProcessMutex > mutex_alloc;
